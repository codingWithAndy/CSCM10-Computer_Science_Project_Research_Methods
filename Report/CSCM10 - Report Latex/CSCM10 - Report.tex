...
\documentclass[11pt, a4paper, openright]{custard}
...
% Abstract comes before the contents page.	
	\begin{abstract}
		...
		We will, in this report, be exploring the background of gamification, as well as how the science of gamification works, and practices currently used. In this report, we will also reflect on how to take a scientific topic, for example, \ac{ML}, and ways of applying gamification practices to them. While also taking into account the additional aspect of integrating gamification within education and teaching.
	\end{abstract}
